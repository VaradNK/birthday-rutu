...
import songA from "./music/savera.mp3";
import songB from "./music/tummile.mp3";
import songC from "./music/sahiba.mp3";
...
const playlist = ["Savera", "Tum Mile", "Sahiba"];
...
const TimelineComponent: React.FC<{ onProceed: () => void }> = ({ onProceed }) => {
  const timelineEvents = [
    { icon: "🌟", title: "Before You Knew...I Existed", desc: "Before we exchanged a single word…You already had a place inside me...You were the calm I didn’t know I was looking for🦋!!!" },
    { icon: "💌", title: "The Calm That Caught Me", desc: "You didn’t try to be cute — you just were & somehow, without warning…you became my favorite peace🌸!!" },
    { icon: "🎵", title: "You Still Don’t Know This Part", desc: "Sometimes, I type and delete...Sometimes, I smile at your texts longer than I should😅!!" },
    { icon: "✨", title: "To be continued...", desc: "I don’t know where this goes...& honestly? That’s the best part, because with you every moment feels like the beginning of something worth waiting for...💭💖⏳🌙" }
  ];
                  ...
                  >
                    ...
                    >
                      ...
                      <p className="text-gray-700 text-sm text-center px-2">
                        Your “ho ho” hits harder than my flirting does… every time. 😄💘
                      </p>
